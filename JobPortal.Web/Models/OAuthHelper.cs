...
public class OAuthHelper
{
    ...
    //static string oauth_consumer_key = "o6yEHh8K3fRjjWwWLdxjchb8H";
    //static string oauth_consumer_secret = "hzcKoM5vCsiXlcHdQ4GXWvWb1ZCyLzojquXsXq04JWMj1Qt39d";

    static string oauth_consumer_key = "Rk1DX05rc1NaVnAxckNBR1BKcTk6MTpjaQ";
    static string oauth_consumer_secret = "1Ls5gG1gzgPED3L83DyN0V-ku5OKa8npj41SLzKyZ7kYR7Gmwh";
    // static string callbackUrl = "htttps://www.joblisting.com/Employer/oauthreturn";
    static string callbackUrl = "https://www.joblisting.com/account/TwitterCallback";
    ...
    static string VERIFY_CREDENTIALS = "https://api.twitter.com/1.1/account/verify_credentials.json";
    ...
    public void GetUser(string oauth_token, string oauth_verifier)
    {
        HttpWebRequest request = FetchUser(httpMethod.GET, oauth_consumer_key, oauth_consumer_secret, oauth_token, oauth_verifier);
        string result = getResponce(request);
    ...
    HttpWebRequest FetchUser(httpMethod method, string oauth_consumer_key, string oauth_consumer_secret, string oauth_token, string oauth_verifier)
    {
        string postData = "oauth_verifier=" + oauth_verifier;
        string AccessTokenURL = string.Format("{0}?{1}", VERIFY_CREDENTIALS, postData);
        string OAuthHeader = OAuthUtility.GetAuthorizationHeaderForPost_OR_QueryParameterForGET(new Uri(AccessTokenURL), callbackUrl, method.ToString(), oauth_consumer_key, oauth_consumer_secret, oauth_token, "", out AccessTokenURL);
