...
public class OAuthHelperJobseeker
{
    public OAuthHelperJobseeker() { }
    ...
    static string oauth_consumer_key = "NXFn9g7fJiDFF6tQQrSXzHDTB";
    static string oauth_consumer_secret = "XjIyrg029PNIpEMGIXAYNAme8YmIBtbc3zBjfqMabGO3UnD8Ru";

   // static string callbackUrl = "htttps://www.joblisting.com/JobSeeker/oauthreturn";
    //static string callbackUrl = "https://www.joblisting.com/JobSeeker/oauthreturn";
    static string callbackUrl = "https://www.joblisting.com/JobSeeker/oauthreturn";
    ...
    public void TweetOnBehalfOf(string oauth_access_token, string oauth_token_secret, string postData)
    {
        ...
        string result = OAuthHelperJobseeker.getResponce(request);
